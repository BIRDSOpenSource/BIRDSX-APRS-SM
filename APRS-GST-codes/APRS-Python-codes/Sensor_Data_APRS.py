        ...
        try:
            while True:
                ...
                if wind_speed_acc:
                    ...
                    parts = data.split('/')
                    if len(parts) == 2:
                        aprs_data = f'{callsign_src}>{callsign_des},{digi_path}::Dragonfly:{parts[0]}/ws{wind_speed_acc}{parts[1]}'
                        #if trend_data:
                        ...
                        aprs_data = f'{callsign_src}>{callsign_des},{digi_path}::Dragonfly:{data}'
                    wind_speed_acc = None  # Reset wind_speed after using it
                else:
                    ...
                    parts = data.split('/')
                    if len(parts) == 2:
                        aprs_data = f'{callsign_src}>{callsign_des},{digi_path}::Dragonfly:{parts[0]}/ws0.00{parts[1]}'
